 ...
 */
@DifyHttpExchange
@HttpExchange(url = "{scheme}://{host}/{path}", contentType = "application/json; charset=utf-8", accept = {"application/json"})
public interface DifyApiProxy {
    ...
    DifyPageRsp<ConversationData> conversationList(@RequestParam String user, @RequestParam("last_id") String lastId, @RequestParam Integer limit, @RequestParam("sort_by") String sortBy, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //删除会话
    @DeleteExchange(url = "/conversations/{conversationId}")
    DifyRspV2 conversationDelete(@PathVariable String conversationId, @RequestBody ConversationParam chatMsgParam, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //会话重命名
    @PostExchange(url = "/conversations/{conversationId}/name")
    ConversationData conversationRename(@PathVariable String conversationId, @RequestBody ConversationParam chatMsgParam, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //语音转文字
    @PostExchange(url = "/audio-to-text", contentType = "multipart/form-data")
    AudioToTextData audioToText(@RequestParam String user, @RequestPart Resource file, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //文字转语音
    @PostExchange(url = "/text-to-audio", accept = {"audio/wav"})
    Resource textToAudio(@RequestParam String user, @RequestParam("message_id") String messageId, @RequestParam String text, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //获取应用基本信息
    @GetExchange(url = "/info")
    AppInfoData appInfo(@RequestParam String user, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //获取应用参数
    @GetExchange(url = "/parameters")
    AppConfigInfoData appConfigInfo(@RequestParam String user, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;

    //获取应用Meta信息
    @GetExchange(url = "/meta")
    String appMetaInfo(@RequestParam String user, @PathVariable String scheme, @PathVariable String host, @PathVariable String path, @RequestHeader("Authorization") String authorization) throws BusinessException;
